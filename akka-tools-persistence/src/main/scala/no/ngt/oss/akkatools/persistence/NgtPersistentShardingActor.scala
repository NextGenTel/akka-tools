...
abstract class NgtPersistentShardingActor[E:ClassTag, Ex <: Exception : ClassTag]
(
  idleTimeout:FiniteDuration,
  ourDispatcherActor:ActorPath
  ) extends NgtPersistentActor[E, Ex](idleTimeout) {
...
abstract class NgtPersistentShardingJavaActor[Ex <: Exception : ClassTag](idleTimeout:FiniteDuration, ourDispatcherActor:ActorPath) extends NgtPersistentShardingActor[AnyRef, Ex](idleTimeout, ourDispatcherActor) with NgtPersistentJavaActorLike {
