...
public class AbstractJavaTest extends JUnitSuite {

    static Logger logger = LoggerFactory.getLogger(AbstractJavaTest.class);
    static ActorSystem system;

    @BeforeClass
    public static void setup() {
        logger.info("Setting up java-test");
        system = ActorSystem.create("AbstractJavaTest", ConfigFactory.load("application-test.conf"));
    }
